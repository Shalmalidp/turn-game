...
(function () {
  ...
  describe('About My Monkey Purple', function () {
    ...
    beforeEach(function () {
      window.x = new _monkey12['default']();
    });

    describe('creating Purple', function () {
      it('should create an instance of Monkey1', function () {
        expect(x instanceof _monkey12['default']).to.equal(true);
      });
    });
  ...
  describe('About My Monkey King', function () {
    ...
    beforeEach(function () {
      window.x = new _monkey22['default']();
    });

    describe('creating King', function () {
      it('should create an instance of Monkey2', function () {
        expect(x instanceof _monkey22['default']).to.equal(true);
      });
    });
...
},{"./game":1,"./monkey1":2,"./monkey2":3}],5:[function(require,module,exports){
/*!
